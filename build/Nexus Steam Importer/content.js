...
(function initializeNexusImporter() {
  ...
  const MODAL_STYLES = `
    ...
    * { box-sizing: border-box; }
    ...
    a { color: inherit; }
    .backdrop { align-items: center; background: rgba(4, 5, 7, .76); display: none; inset: 0; justify-content: center; padding: 24px; pointer-events: auto; position: fixed; backdrop-filter: blur(8px); }
    ...
    .content { min-height: 310px; overflow: auto; padding: 24px; }
